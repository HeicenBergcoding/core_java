...
public class SetDemoOne {
    public static void main(String[]args){
        ...
        //Set<Integer> rolls = new TreeSet<>();     //Treeset helps us to sort in ascending order
        ...
        rolls.add(null);//Treeset doesn't allow null values will throw null pointer exception but hashset does
        for(Integer r:rolls){
